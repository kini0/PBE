  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #2b0602;">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="/candidats/profile" class="d-block">{{ Auth::user()->name }}</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="{{ route('candidat') }}" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="/candidats/chats" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/candidats/facture" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/candidats/statistique" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/candidats/calendrier" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/candidats/gallery" class="nav-link">
          ...
          <li class="nav-item">
                <a href="/candidats/blog" class="nav-link">
                    <i class="nav-icon fas fa-book"></i>
                    <p>Blog</p>
                </a>
            </li>
          <li class="nav-item">
            <a href="/candidats/documentPBE" class="nav-link">
              <i class="nav-icon fas fa-file"></i>
              <p>Documentation PBE</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="/candidats/profile" class="nav-link">

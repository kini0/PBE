    ...
    <div class="container px-4 py-5" id="featured-3">
      <div class="row mb-3">
        <div class="col-6 themed-grid-col">
          <h2 class="pb-2 border-bottom">Gallery Candidat</h2>
        </div>
        <div class="col-6 themed-grid-col pb-2">
          <a href="/candidats/gallery-create">
            <button type="button" class="btn btn-primary float-right" align-text="right">Add Image</button>
          </a>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
        ...
        <div class="col d-flex align-items-start">
          ...
          <div>
            ...
            <p>{{$blog->soustitle}}.</p>
            <a href="/candidats/blog/{{$blog->id}}/{{$blog->title}}">Lire</a>
          </div>
        </div>
        @endforeach

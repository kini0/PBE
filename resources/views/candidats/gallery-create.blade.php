        ...
        <div class="col-md-3">
          ...
          <div class="card card-primary card-outline">
            <div class="card-body box-profile">
              ...
              <a href="#" class="btn btn-primary btn-block"><b>{{Auth::user()->name}}<br>{{Auth::user()->email}}</b></a>
            </div>
            <!-- /.card-body -->
          </div>
          <!-- /.card -->
            ...
            <div class="card-body">
              <div class="tab-content">
                <div class="active tab-pane" id="settings">
                  <form class="form-horizontal" action="/candidats/gallery" method="post" enctype="multipart/form-data">
                    @csrf

    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12 themed-grid-col">
          <div class="pb-3">
            <h1>L'apperçu de vos dossiers</h1>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-6 themed-grid-col">Email: <strong>{{Auth::user()->email}}</strong></div>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      ...
                      <a class="btn btn-primary" href="/dossiers/edit/{{ $dossier->id }}" role="button">Edit</a>
                    </div>

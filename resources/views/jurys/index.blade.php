...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Tableau de bord Jurys</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-danger">
            ...
            <a href="/jurys/listemoyenne" class="small-box-footer">Voir liste<i class="fas fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
        <!-- ./col -->
      ...
      <section class="table table-bordered table-striped table-sm table-xs table-md table-lg">
        <table class="table table-bordered table-striped table-sm table-xs table-md table-lg">
          ...
          <tr>
            ...
            <td>
              <a href="/jurys/show/{{ $doc['id'] }}" class="btn btn-primary">Veiw</a>
            </td>
        ...
        <div class="d-flex justify-content-center">
          <!-- ici je dois mettre la pagination des donnés-->
        </div>
      </section>
    </div><!-- /.container-fluid -->
  </section>
  ...
  <main>
    ...
    <div class="container px-4 py-5" id="icon-grid">
      <h2 class="pb-2 border-bottom">Actualité</h2>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
        ...
        <div class="col d-flex align-items-start">
          ...
          <div>
            ...
            <p>{{$blog->soustitle}}.</p>
            <a href="/jurys/blog/{{$blog->id}}/{{$blog->title}}">Lire</a>
          </div>
        </div>
        @endforeach

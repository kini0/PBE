          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <p class="text-muted text-center">Membre du Jury N°{{Auth::user()->id}}</p>
                <form method="POST" action="/jurys/profile/{{Auth::user()->id}}" enctype="multipart/form-data" class="form-group">
                        @csrf
                        @method('put')
              ...
              <div class="card-body">
                <div class="tab-content">
                    <div class="active tab-pane" id="timeline">
                        <!-- The timeline -->
                        <form class="form-horizontal" method="POST" action="/jurys/profile-info/{{Auth::user()->id}}" enctype="multipart/form-data">
                        @csrf
                        @method('put')

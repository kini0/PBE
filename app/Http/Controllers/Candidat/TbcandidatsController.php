...
class TbcandidatsController extends Controller
{
...
// This gives a DateInterval instance
        ...
        return view('candidats.index', compact('infocandidat','nmb', 'galleries', 'date1', 'date2', 'difference', 'blogs'));
    }
    ...
    public function pbe(){
        return view('candidats/documentPBE');
    }
